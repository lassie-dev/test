...
import { ArrowLeft, Edit, Trash2, FileText, Calendar, User, Users, DollarSign, Package } from 'lucide-react';
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {contract.servicios.map((item, index) => (
                    <Card key={index} className="relative overflow-hidden hover:shadow-lg transition-shadow duration-200 border-2">
                      {/* Quantity Badge */}
                      ...
                      <CardContent className="p-6 space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-gray-500">{t('contracts.unitPriceFull')}</span>
